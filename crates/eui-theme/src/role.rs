...
impl Role {
    ...
    pub const ALL: [Role; 28] = [
        Role::SurfaceBase, Role::SurfaceRaised, Role::SurfaceSunken, Role::SurfaceOverlay,
        Role::TextDefault, Role::TextMuted, Role::TextInverted, Role::TextDisabled,
        Role::AccentBase, Role::AccentHover, Role::AccentActive, Role::AccentOn,
        Role::SuccessBase, Role::SuccessSubtle, Role::SuccessOn,
        Role::WarningBase, Role::WarningSubtle, Role::WarningOn,
        Role::DangerBase, Role::DangerSubtle, Role::DangerOn,
        Role::InfoBase, Role::InfoSubtle, Role::InfoOn,
        Role::BorderSubtle, Role::BorderDefault, Role::BorderStrong, Role::FocusRing,
    ];
