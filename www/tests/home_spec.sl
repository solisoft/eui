...
describe("Components", fn() {
  ...
  test("carries the whole vocabulary", fn() {
    ...
    # the page contradicts itself; the markdown editor's handler builders
    # took it to 264, and the eighteen families on the page add to that.
    assert_contains(body, "All 264")
