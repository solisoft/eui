...
```bash
rbuild soli eui/www test                                 # whole suite
rbuild soli eui/www test tests/<the-relevant-spec>.sl    # one spec, fast feedback
rbuild soli eui/www test --coverage --coverage-min 90.0
```
